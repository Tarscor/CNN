                        ...
                        for(int fx = 0; fx < filter_width; fx++) {
                            ...
                            if(in_y >= 0 && in_y < in_height && in_x >=0 && in_x < in_width) {
                                for(int fd = 0; fd < filter_depth / 4 * 4; fd+=4) {
                                    ...
                                    sum += filter_weights[((filter_width * fy) + fx) * filter_depth + fd+1] + in_weights[((in_width * fy) + fx) * in_depth + fd+1];
                                    sum += filter_weights[((filter_width * fy) + fx) * filter_depth + fd+2] + in_weights[((in_width * fy) + fx) * in_depth + fd+2];
